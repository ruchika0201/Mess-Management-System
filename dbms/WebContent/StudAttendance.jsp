...
<section id="left"> 
  <table>
    ...
    <tr>
      <td id="rcorners2" bgcolor="yellow" height=50><a href="StudAttendance.jsp"><font size="5" style="color:black">ATTENDANCE</a></td>
    </tr>
    <tr>
...
try{
    ...
    int student_id=Integer.parseInt(session2.getAttribute("id").toString());	
	 ...
	 String q="select * from student where stud_id like ?";
...
%>
	...
	<td><font style="color:white"><%=counter %></td>
